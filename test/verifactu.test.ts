...
describe('VeriFacTu Library', () => {
    ...
    describe('createVerifactuInvoice', () => {
        it('should create a valid invoice', async () => {
            ...
            const result = await createVerifactuInvoice(invoice, software, previousId);
        ...
        it('should create a valid first invoice', async () => {
            ...
            expect(xmlDecoded).toContain('<PrimerRegistro>S</PrimerRegistro>');
            expect(xmlDecoded).not.toContain('<RegistroAnterior>');
        });
        ...
        it('should create a valid simplified invoice', async () => {
            ...
            expect(xmlDecoded).toContain('<TipoFactura>F2</TipoFactura>');
            // Simplified invoices should not have Destinatarios section
            expect(xmlDecoded).not.toContain('<Destinatarios>');
        });

        it('should throw error for invalid invoice', async () => {
            const invalidInvoice = {} as Invoice;

            await expect(createVerifactuInvoice(invalidInvoice, software)).rejects.toThrow();
        });
    });
    ...
    describe('cancelVerifactuInvoice', () => {
        it('should cancel an invoice', async () => {
            ...
            const result = await cancelVerifactuInvoice(cancelInvoice, software, previousId);
        ...
        it('should throw error for invalid cancel invoice', async () => {
            ...
            await expect(cancelVerifactuInvoice(invalidCancelInvoice, software)).rejects.toThrow();
        });
    });
});
